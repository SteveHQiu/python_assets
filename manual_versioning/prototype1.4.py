...
"""
Changelog
-Added full expansion of direct child nodes
-Added image parsing to same level and direct child nodes
"""
                    ...
                    for OE_subnode in OE_node.find("one:OEChildren", namespace):
                        ...
                        if notNone(OE_subnode_content): # Filters for any text features including raw points 
                            ...
                            if OE_subnode.find("one:OEChildren", namespace) != None:
                                ...
                                subsubpoints = "".join((subsubpoints, "<li><span style='color:#BEBEBE'>%s</span></li>" % "PLACEHOLDER")); # Close sub-sub-list
