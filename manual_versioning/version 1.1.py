...
"""
Changelog
-Added support for concept-like attributes being nested under concept-like groupings 
        ...
        for OE1 in OEChildren1: # Parse concepts at lowest level of bullets
            ...
            if notNone(OE1_content) and getGeneralStem(OE1_content.text) != None:
                ...
                for parent in parent_tracker: # Wraps info of parent nodes around returned HTML list 
                    if getGroupingStem(OE1_content.text) != None and parent_tracker.index(parent) == 0: # Only display parent in non-grey if it is a grouping, index is to make sure that it is the immediate parent, of the current node, otherwise will treat as a distant parent 
