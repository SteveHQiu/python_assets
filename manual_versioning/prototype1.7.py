...
"""
Changelog - MVP, alpha
-Added parent node displays
-Added recursive parsing to child nodes
-Added failsafe closing of anki
...
def iterHeaders(OEChildren_outline: object) -> None:
    ...
    try:
        ...
        for OE_header in OEChildren_outline:
            ...
            parent_tracker = []
            indent_tracker = 0; # Levels {0: root points, 1: sub points, 2: sub-sub points,...}
            if notNone(OE_header.find("one:T", namespace)): 
